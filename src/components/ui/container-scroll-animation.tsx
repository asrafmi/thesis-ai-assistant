...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[24rem] md:h-[32rem] w-full border border-white/10 p-2 md:p-4 bg-[#09090b] rounded-[24px] shadow-2xl"
    >
      <div className="h-full w-full overflow-hidden rounded-xl bg-[#18181b]">
        {children}
      </div>
    </motion.div>
  );
